...
import numpy as np
import cv2
from dutil import add_pos,auto_canny,save_image
...
def draw_generated():
#	pygame.surfarray.blit_array(gen_surface_mini, np.transpose(cur_gen, (1,2, 0)))
...
#			print(pred.shape)
    #		pred = model.predict(add_pos(add_pos(fdrawing)), batch_size=1)[0]
